...
cl = Han.LINE()
cl.login(token="Eryyd2AgtNxcNMLRlZt6.5VPc9GWyB4ScDX1XmFLK5G.hGgQxj4COtMaaNK2Y1wKLcUxKojRMA8z3oV5Tk/yLzc=")
cl.loginResult()
...
Bots = [mid,"u57edc3056a172603616a8e808172b672"]
admsa = "u57edc3056a172603616a8e808172b672"
admin = "u57edc3056a172603616a8e808172b672"
crash = "ua7fb5762d5066629323d113e1266e8ca"
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':" Thank For Add Me\n\nSelf Creator ʙʏ HANS\n\nhttp://line.me/ti/p/opcn8DF8P0 ",
    "lang":"JP",
    "comment":"Aᴜᴛᴏ Lɪᴋᴇ ʙʏ HANS\n\nhttp://line.me/ti/p/opcn8DF8P0 ",
    "commentOn":True,
    "likeOn":True,
    "commentBlack":{},
    "wblack":False,
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                #cl.sendText(msg.to,"ɪᴅ Line http://line.me/ti/p/Zef93dDkpA\n\nʙɪʟᴀ ᴀᴅᴀ ᴘᴇʀʟᴜ ᴘᴄ ᴋᴏɴᴛᴀᴋ ᴅɪʙᴀᴡᴀʜ 😁")
                #msg.contentType = 13
...
#-----------------------------------------------
    #-------------TagALL Finish-------------#           
            ...
            elif 'nama grup: ' in msg.text.lower():
                if msg.toType == 2:
                    wildan = cl.getGroup(msg.to)
                    wildan.name = msg.text.replace("nama grup: ","")
